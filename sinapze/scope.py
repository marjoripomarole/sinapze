...
sinapze figure out scope automatically. Drop this in the frontmatter of
your notes:
...
Then run `sinapze scope --exam prova1 --from-frontmatter` and every note
matching `exam: prova1` is in scope, ranked by exam_weight × high_yield.
"""

from __future__ import annotations

from sinapze.models import Scope, Source
